...
var ns = {
    ...
    AggAvg: require('./agg/AggAvg'),
    AggAvgDistinct: require('./agg/AggAvgDistinct'),
    AggCount: require('./agg/AggCount'),
    AggCountDistinct: require('./agg/AggCountDistinct'),
    AggGroup_Concat: require('./agg/AggGroup_Concat'),
    AggGroup_ConcatDistinct: require('./agg/AggGroup_ConcatDistinct'),
    AggMax: require('./agg/AggMax'),
    AggMaxDistinct: require('./agg/AggMaxDistinct'),
    AggMin: require('./agg/AggMin'),
    AggMinDistinct: require('./agg/AggMinDistinct'),
    AggregatorBase: require('./agg/AggregatorBase'),
    AggregatorFactory: require('./agg/AggregatorFactory'),
    AggregatorSpecification: require('./agg/AggregatorSpecification'),
    AggSum: require('./agg/AggSum'),
    AggSumDistinct: require('./agg/AggSumDistinct'),
    ...
    ElementHaving: require('./element/ElementHaving'),
    ...
    E_NotEquals: require('./expr/E_NotEquals'),
